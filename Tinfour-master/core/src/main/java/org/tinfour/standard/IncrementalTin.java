 ...
 * 测试表明，TIN构建操作中最耗时的部分是Java对象的构建。如上所述，此类每个顶点需要6个与边相关的对象。
 ...
 * 16:853-869</cite>.
 * <cite>Soukal，R.很好地回顾了使用随机Lawson步行的点定位。；马&#769；lkova&#769；，Kolingerova&#769；（2012）
 * “三角网模型中点定位的行走算法”，计算地球科学16:853-869</cite>
 * <p>
